...
class EpisodesControllerTest < ActionController::TestCase
  ...
  test "should create episode" do
    assert_difference('Episode.count') do
      post :create, episode: { content: @episode.content, index: @episode.index, story_id: @episode.story_id }
    end
  ...
  test "should update episode" do
    patch :update, id: @episode, episode: { content: @episode.content, index: @episode.index, story_id: @episode.story_id }
    assert_redirected_to episode_path(assigns(:episode))
  end
